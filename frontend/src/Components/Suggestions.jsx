  ...
  return (
    <>
      <div className="p-6 ">
        ...
        <div className="flex flex-col gap-6 md:w-[100%] md:flex-row md:flex-wrap ">

          <div className="md:w-[48%] flex justify-between items-center bg-gray-100 p-6 rounded-2xl ">
            <div>
