...
function Home() {
  return (<>
    ...
    <div className="pt-[70px]">
      ...
      {/* Ride Options and Why Choose Uber Section */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl font-bold mb-6">Why choose Uber?</h2>
                <p className="text-gray-600 text-lg mb-8">
                  Experience the best ride-sharing service with millions of satisfied customers worldwide.
                </p>
              </div>
              ...
              <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Available in 10,000+ cities across 70+ countries. Go anywhere, anytime.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-xl">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold mb-2">Top-rated drivers</h3>
                      <p className="text-gray-600">
                        All drivers are background-checked and highly rated by our community.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-xl">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Pay with cash, card, or digital wallet. Choose what works best for you.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-xl">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Book a ride in seconds with our intuitive app. Track your driver in real-time.
                      </p>
                    </div>
                  </div>
                </div>
