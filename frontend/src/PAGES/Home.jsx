...
function Home() {
  return (<>
    ...
    <div className="p-5 -ml-4">
                <Link to="/BookRide" className='border rounded-lg p-3 bg-black text-md text-white ml-5  h-12 w-36'>See Prices</Link>
                {/* <button className='border rounded-xl bg-black text-m text-white ml-5  h-12 w-36'>See prices</button> */}
                <Link to={'/Login'} className='ml-10 underline underline-offset-8'>log in to see your recent activity</Link>
