...
//       {/* 🌍 Map container */}
//       <div className="w-[100%] h-[350px] z-0 rounded-2xl overflow-hidden shadow-lg border border-gray-300 bg-white md:w-[50%] md:ml-[560px] flex flex-col">
...
//                     <strong>time:</strong> {moment(ride.time, "HH:mm").format("h:mm A")}<br />
//                   </p>
