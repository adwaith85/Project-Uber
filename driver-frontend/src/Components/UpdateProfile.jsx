        ...
        <div className="flex-1 flex justify-center items-center px-4 py-12">
          <div className="w-full max-w-md">
            ...
            <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-xl rounded-2xl p-8 border border-gray-700/50 shadow-2xl">
              <h2 className="text-3xl font-bold text-center mb-2 text-transparent bg-clip-text bg-black">
                Update Profile
              </h2>
              <p className="text-gray-900 text-center mb-8">Change your profile picture</p>

              {/* File Input */}
              <div className="mb-6">
                <label className="block font-semibold mb-3 text-gray-200">Select Image</label>
                <input
                  type="file"
                  accept="image/*"
                  onChange={handleFileChange}
                  className="w-full bg-gray-700/30 border border-gray-600/50 rounded-lg px-4 py-3 text-gray-300 placeholder-gray-500 focus:outline-none focus:border-gray-500/50 focus:bg-gray-700/50 transition file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-green-500/20 file:text-gray-100 hover:file:bg-green-500/30"
                />
              </div>
                ...
                <div className="mb-6 text-center">
                  <div className="relative inline-block">
                    <img
                      src={preview}
                      alt="Preview"
                      className="w-40 h-40 object-cover rounded-full mx-auto border-4 border-blue-500/50 shadow-lg shadow-orange-500/20"
                    />
                  </div>
                  <button
              ...
              <button
                onClick={UpdateData}
                className="w-full py-3 bg-gradient-to-r from-blue-900 to-gray-900 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-white transition transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Update Profile
              </button>
