    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
      ...
      <nav className="relative z-50 flex justify-between items-center px-6 md:px-12 py-6">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full flex items-center justify-center font-bold text-lg">
            🚗
          </div>
        ...
        <div className="flex gap-4">
          <button
            ...
            className="px-6 py-2 text-white hover:text-orange-400 transition font-semibold"
          >
            Login
          </button>
          <button
            onClick={() => navigate("/register")}
            className="px-6 py-2 bg-gradient-to-r from-orange-400 to-orange-600 rounded-lg font-semibold hover:shadow-lg hover:shadow-orange-500/50 transition transform hover:scale-105"
          >
            Register
          </button>
        </div>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 md:px-12 py-12 md:py-24">
        <div className="text-center mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <button
              onClick={() => navigate("/login")}
              className="px-8 py-3 md:px-10 md:py-4 bg-gradient-to-r from-orange-400 to-orange-600 text-white font-bold rounded-lg hover:shadow-2xl hover:shadow-orange-500/50 transition transform hover:scale-105 text-lg"
            >
              Login to Dashboard
            </button>
            <button
              onClick={() => navigate("/register")}
              className="px-8 py-3 md:px-10 md:py-4 border-2 border-orange-400 text-orange-400 font-bold rounded-lg hover:bg-orange-400/10 transition text-lg"
            >
              Start as New Driver
            </button>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6 md:gap-12 mb-12">
            {stats.map((stat, idx) => (
              <div key={idx} className="text-center">
                <div className="text-2xl md:text-4xl font-bold text-orange-400 mb-2">
                  {stat.number}
                </div>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 md:px-12 py-16 md:py-24">
        <h2 className="text-3xl md:text-5xl font-bold text-center mb-4">
          Why Choose
          <span className="bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent"> DriveEarn?</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="group p-6 md:p-8 rounded-xl bg-gray-800/50 border border-gray-700 hover:border-orange-500/50 transition transform hover:scale-105 backdrop-blur-sm"
            >
              <div
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-6 md:px-12 py-16 md:py-24">
        <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl p-8 md:p-12 text-center">
          ...
          <button
            onClick={() => navigate("/register")}
            className="px-10 py-3 md:py-4 bg-white text-orange-600 font-bold rounded-lg hover:shadow-xl transition transform hover:scale-105 text-lg"
          >
            Register Now →
          </button>
        </div>
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-gray-700 mt-16 md:mt-24 py-8 md:py-12 px-6 md:px-12">
